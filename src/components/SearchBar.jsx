...
export default function SearchBar({ query, setQuery, status, setStatus, count }) {
  return (
    <div className="space-y-4">
      ...
      >
        <span className="text-xl" style={{ color: 'var(--ink-muted)' }}>⌕</span>
        <input
          type="text"
          autoFocus
          value={query}
          ...
          className="flex-1 bg-transparent outline-none font-body text-base placeholder:opacity-50"
          style={{ color: 'var(--ink)' }}
        />
        {query && (
          <button
